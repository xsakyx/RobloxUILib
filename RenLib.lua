--[[
    DOMINATION UI LIBRARY
    Build: 3.0.0-Titan
    Author: Antigravity
    License: Proprietary / MIT
    
    The most advanced, feature-rich, and optimized UI library for Roblox Executors.
    Designed to outperform Sirius, Rayfield, and Luna in every metric.
    
    FEATURES:
    - [Core] Single-file monolithic architecture (Zero dependencies)
    - [Core] custom 'Signal' class for high-performance event handling
    - [Core] 'Janitor' class for rigorous garbage collection
    - [Anim] Physics-based 'Spring' engine (Hooks Law)
    - [Render] Real-time Acrylic Blur handling
    - [Render] SliceScale Shadow engine
    - [Input] Advanced Input State Machine for Keybinds
    - [Config] JSON-based Auto-Saving & Theme Manager
